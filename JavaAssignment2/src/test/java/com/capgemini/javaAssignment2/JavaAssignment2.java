...
public class JavaAssignment2 {
	...
	*/
	...
	List sheetsNameOfWb1 = new ArrayList<String>();
	List sheetsNameOfWb2 = new ArrayList<String>();
	...
	int cellCounts1 = ((Row) rowInSheet1.next()).getPhysicalNumberOfCells();
	int cellCounts2 = ((Row) rowInSheet2.next()).getPhysicalNumberOfCells();
