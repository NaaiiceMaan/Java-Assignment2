...
public class JavaAssignment2 {
	...
	public static void main(String[] args) throws Exception {
		...
		reader1 = new CSVReader(new FileReader("./src/test/resources/DataSourceFile1.csv"));    
		...
		reader2 = new CSVReader(new FileReader("./src/test/resources/DataSourceFile2.csv"));  
		...
		File file = new File("./src/test/resources/results/difference.csv");
		FileWriter fw = new FileWriter(file);
		BufferedWriter bw = new BufferedWriter(fw);
		bw.write("Source,"+"Target,"+"Difference,"+"Source,"+"Target,"+"Difference,"+"Source,"+"Target,"+"Difference,");
		bw.newLine();

		for(int i=3;i<array1.size();i++)
		{
